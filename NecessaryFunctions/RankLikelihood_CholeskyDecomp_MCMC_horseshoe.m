...
num_samples = 15000; 
    ...
    inverse_correlation_sims_chain_tmp = zeros([p,p,num_samples]);
...
inverse_correlation_sims_chain_tmp(:,:,iters_num) = inverse_correlation_regularized;



Bayes_est_z_iters(:,:,iters_num) = Z; %these cost some time
