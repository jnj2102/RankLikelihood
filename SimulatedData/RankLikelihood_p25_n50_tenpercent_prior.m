...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Simulation combination: n50, p25, sparsity = tenpercent
...
%save('RankLikelihood_Sigma_true_p25_n50_tenpercent.mat','sigma_true');

%save the omega matrix for R
%save('RankLikelihood_Omega_true_p25_n50_tenpercent.mat','omega_true');
...
reps = 100;
    ...
    optimalJ_n50_p25_tenpercent = cell([reps,1]);
    minK_n50_p25_tenpercent = cell([reps,1]);
    Final_AIC_n50_p25_tenpercent = cell([reps,1]);
...
for iters = 1:reps
    ...
    % generate the true y using the tenpercent model
   ...
   % save(sprintf('RankLikelihood_Iter_%d_X_matrix_p25_n50_tenpercent.mat', iters), 'x_matrix');
...
N_points);
    ...
    optimalJ_n50_p25_tenpercent{iters} = optimalJ;
    minK_n50_p25_tenpercent{iters} = minK;
    Final_AIC_n50_p25_tenpercent{iters} = Final_AIC;
...
save('RankLikelihood_p25_n50_tenpercent_prior.mat');
