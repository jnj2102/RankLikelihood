...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Simulation combination: n500, p100, sparsity = twopercent
...
%save('RankLikelihood_Sigma_true_p100_n500_twopercent.mat','sigma_true');

%save the omega matrix for R
%save('RankLikelihood_Omega_true_p100_n500_twopercent.mat','omega_true');
...
reps = 100;
    ...
    optimalJ_n500_p100_twopercent = cell([reps,1]);
    minK_n500_p100_twopercent = cell([reps,1]);
    Final_AIC_n500_p100_twopercent = cell([reps,1]);
...
for iters = 1:reps
    ...
    % generate the true y using the twopercent model
    ...
    MLE_ald_n500_p100{iters} = MLE_ald;
    MLE_log_n500_p100{iters} =  MLE_log;


    
    %save the x matrix as a mat file for R
    
   % save(sprintf('RankLikelihood_Iter_%d_X_matrix_p100_n500_twopercent.mat', iters), 'x_matrix');
...
N_points);
    ...
    optimalJ_n500_p100_twopercent{iters} = optimalJ;
    minK_n500_p100_twopercent{iters} = minK;
    Final_AIC_n500_p100_twopercent{iters} = Final_AIC;
...
save('RankLikelihood_p100_n500_twopercent_prior.mat');
