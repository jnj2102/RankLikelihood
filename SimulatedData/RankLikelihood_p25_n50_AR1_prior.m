...
%save('RankLikelihood_Sigma_true_p25_n50_AR1.mat','sigma_true');

%save the omega matrix for R
%save('RankLikelihood_Omega_true_p25_n50_AR1.mat','omega_true');
...
for iters = 1:reps
   ...
   % save(sprintf('RankLikelihood_Iter_%d_X_matrix_p25_n50_AR1.mat', iters), 'x_matrix');
...
save('RankLikelihood_p25_n50_AR1_prior.mat');
