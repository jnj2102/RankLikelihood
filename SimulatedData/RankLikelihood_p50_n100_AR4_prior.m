...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Simulation combination: n100, p50, sparsity = AR4
...
%save('RankLikelihood_Sigma_true_p50_n100_AR4.mat','sigma_true');

%save the omega matrix for R
%save('RankLikelihood_Omega_true_p50_n100_AR4.mat','omega_true');
...
reps = 100;
    ...
    optimalJ_n100_p50_AR4 = cell([reps,1]);
    minK_n100_p50_AR4 = cell([reps,1]);
    Final_AIC_n100_p50_AR4 = cell([reps,1]);
...
for iters = 1:reps
   ...
   % save(sprintf('RankLikelihood_Iter_%d_X_matrix_p50_n100_AR4.mat', iters), 'x_matrix');
...
N_points);
    ...
    optimalJ_n100_p50_AR4{iters} = optimalJ;
    minK_n100_p50_AR4{iters} = minK;
    Final_AIC_n100_p50_AR4{iters} = Final_AIC;
...
save('RankLikelihood_p50_n100_AR4_prior.mat');
