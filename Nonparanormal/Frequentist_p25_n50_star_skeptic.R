...
###########Simulation combination: n=50, p=25, sparsity = star#######
result_list <- list()


data <- readMat('RankLikelihood_p25_n50_star_prior.mat', package = "R.matlab") #Read in all the data
...
save.image(file = "Frequentist_p25_n50_star_skeptic.rdata")
