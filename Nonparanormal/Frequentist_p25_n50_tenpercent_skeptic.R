...
data <- readMat('RankLikelihood_p25_n50_tenpercent_prior.mat', package = "R.matlab") #Read in all the data
...
save.image(file = "Frequentist_p25_n50_tenpercent_skeptic.rdata")
