...
data <- readMat('RankLikelihood_p100_n500_twopercent_prior.mat', package = "R.matlab") #Read in all the data
...
save.image(file = "Frequentist_p100_n500_twopercent_skeptic.rdata")
