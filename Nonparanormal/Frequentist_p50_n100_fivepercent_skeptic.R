...
###########Simulation combination: n=100, p=50, sparsity = fivepercent#######
result_list <- list()


data <- readMat('RankLikelihood_p50_n100_fivepercent_prior.mat', package = "R.matlab") #Read in all the data
...
result_list[[iters]] <- Frequentist_skeptic(omega_true, sigma_true, xmat,n,p,edge_matrix_true,upperind)
...
save.image(file = "Frequentist_p50_n100_fivepercent_skeptic.rdata")
