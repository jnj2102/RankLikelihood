...
###########Simulation combination: n=100, p=50, sparsity = AR1#######
result_list <- list()


data <- readMat('RankLikelihood_p50_n100_AR1_prior.mat', package = "R.matlab") #Read in all the data
...
save.image(file = "Frequentist_p50_n100_AR1_skeptic.rdata")
