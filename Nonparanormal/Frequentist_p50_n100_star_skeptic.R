...
###########Simulation combination: n=100, p=50, sparsity = star#######
result_list <- list()


data <- readMat('RankLikelihood_p50_n100_star_prior.mat', package = "R.matlab") #Read in all the data
...
save.image(file = "Frequentist_p50_n100_star_skeptic.rdata")
