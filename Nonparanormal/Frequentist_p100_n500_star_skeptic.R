...
###########Simulation combination: n=500, p=100, sparsity = star#######
result_list <- list()


data <- readMat('RankLikelihood_p100_n500_star_prior.mat', package = "R.matlab") #Read in all the data
...
save.image(file = "Frequentist_p100_n500_star_skeptic.rdata")
