...
%Horseshoe
load(sprintf('RankLikelihood_p100_n500_AR4_ranks_%dto%d.mat', ssIters,ssIters2) );
   ...
   fprintf('Iterations = %d', num_iters);
    ...
    %Now do the B-splines estimation method    
     ...
     for A_index = 1:num_elements
        ...
        inverse_correlation_Bayes_est =  inverse_correlation_Bayes_est_n500_p100_AR4{A_index, num_iters};
...
entropy_loss_finalanalysis(num_iters)  = entropy_loss_n500_p100_AR4(rowMinBIC, num_iters) ;
 ...
 inverse_correlation_Bayes_est_finalanalysis{num_iters} =   inverse_correlation_Bayes_est_n500_p100_AR4{rowMinBIC,  num_iters};
...
save('RankLikelihood_p100_n500_AR4_ranks_final.mat', '-v7.3');
