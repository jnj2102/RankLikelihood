...
%Horseshoe
load(sprintf('RankLikelihood_p100_n500_AR1_Bsplines_%dto%d.mat', ssIters,ssIters2) );
   ...
   fprintf('Iterations = %d', num_iters);
    ...
    %Now do the B-splines estimation method    
     ...
     for A_index = 1:num_elements
        ...
        Omega_Bayes_est =  Omega_Bayes_est_n500_p100_AR1{A_index, num_iters};
...
entropy_loss_finalanalysis(num_iters)  = entropy_loss_n500_p100_AR1(rowMinBIC, num_iters) ;
 ...
 Omega_Bayes_est_finalanalysis{num_iters} =   Omega_Bayes_est_n500_p100_AR1{rowMinBIC,  num_iters};
...
save('RankLikelihood_p100_n500_AR1_Bsplines_final.mat', '-v7.3');
