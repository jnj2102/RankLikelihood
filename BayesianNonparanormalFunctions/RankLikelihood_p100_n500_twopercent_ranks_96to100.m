...
%Simulation combination: n=500, p=100, sparsity = twopercent
 ...
 %   run('run_to_compile_and_test.m')
   ...
   [num_elements, ~] = size(c_tune_list);
    ...
    inverse_correlation_Bayes_est_n500_p100_twopercent =  cell([num_elements,1, reps]);
...
%save all of the data for each hyperparameter setting.
   ...
   inverse_correlation_Bayes_est_n500_p100_twopercent{A_index, iters} = inverse_correlation_Bayes_est;
...
save('RankLikelihood_p100_n500_twopercent_ranks_96to100.mat', '-v7.3');
