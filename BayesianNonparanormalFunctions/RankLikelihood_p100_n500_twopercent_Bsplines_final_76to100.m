...
load(sprintf('RankLikelihood_p100_n500_twopercent_Bsplines_%dto%d_%d.mat', ssIters,ssIters2,Number_index) );
   ...
   if c_tune ~= c_tune_list(Number_index)
    ...
    % for Number_index = 1:num_elements  %update this.
               
        Omega_Bayes_est =  Omega_Bayes_est_n500_p100_twopercent{Number_index, num_iters};
        final_edge_matrix = edge_matrix_n500_p100_twopercent{Number_index, num_iters};
        
       mean_Z_Bayes_est = mean_Z_Bayes_est_n500_p100_twopercent{Number_index, num_iters};
...
save('RankLikelihood_p100_n500_twopercent_Bsplines_final_76to100.mat', '-v7.3');
